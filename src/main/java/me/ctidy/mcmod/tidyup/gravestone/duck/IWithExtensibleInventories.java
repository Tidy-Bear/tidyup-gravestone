...
package me.ctidy.mcmod.tidyup.gravestone.duck;

import me.ctidy.mcmod.tidyup.gravestone.inv.ExtensibleDeathInventories;

/**
 * IWithExtensibleInventories
 *
 * @author Tidy-Bear
 * @since 2025/1/6
 */
public interface IWithExtensibleInventories {

    ExtensibleDeathInventories getExtensibleInventories();
